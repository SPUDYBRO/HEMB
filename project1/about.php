            ...
            <section id="employee_info" class="main_section">
                ...
                <div class= "individual_employee">
                    <div class="title_image_and_list_flex_container">
                        <div class="title_image">
                            <h3>Evan Harrison</h3>
                            <img class="individual_employee_photos" src="../images/Evan_Harrison.webp" alt="Front-facing picture of Evan Harrison, one of the team members" loading="lazy">
                        </div>
                        <ul>
                ...
                <div class="individual_employee">
                    <div class="title_image_and_list_flex_container">
                        <div class="title_image">
                            <h3>Henry Bennett</h3>
                            <img class="individual_employee_photos" src="../images/Henry_Bennett.webp" alt="Front-facing image of Henry Bennett taking a photo with a phone" loading="lazy">
                        </div>
                        <ul>
                ...
                <div class="individual_employee">
                    <div class="title_image_and_list_flex_container">
                        <div class="title_image">
                            <h3>Ben Romano</h3>
                            <img class="individual_employee_photos" src="../images/Ben_Romano.webp" alt="A front facing picture of Ben Romano" loading="lazy">
                        </div>
                        <ul>
                ...
                <div class="individual_employee">
                    <div class="title_image_and_list_flex_container">
                        <div class="title_image">
                            ...
                            <img class="individual_employee_photos" src="../images/Michael_Sharpley.webp" alt="A Picture of Michael Sharpley outside" loading="lazy">
                        </div>
                        <ul>
