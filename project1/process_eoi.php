...
$prep = $conn->prepare("INSERT INTO users (EOInumber, Job Ref Num, First name, Last name, Address, Email Address, Phone Number, Technical Skills, Preferred Skills, Other Skills, Status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
